...
class AuthenticationManager: NSObject {
    ...
    func twitterUniversalLogin(callback: ResponseUser){
        ...
        oauthswift?.authorize(
            withCallbackURL: "http://oauthswift.herokuapp.com/callback/twitter",
    ...
    func instagramLogin(callback: ResponseUser){
        do {
            ...
            let user = User(name: name, id: id, token: "", email: "")
            print(user)
            callback(user)
        } catch let error {
